...
const ProfileImageChooseScreen = (props: props) => {
    ...
    return (
        <SafeAreaView style={styles.container}>
            <TouchableOpacity
                onPress={() => { props.navigation.navigate('AccessLoactionScreen'), console.log('acc') }}
                activeOpacity={0.8}
            ...
            <View style={styles.imgPickerView}>
                ...
                <Text style={styles.takeSelfieSummary}>{constants.string.selfieSummary}</Text>
                <CustomButton
                    onPress={() => { takeImage() }}
                    txt={constants.string.takePhoto}
                    btnStyle={{
                        width: constants.vw(230), alignSelf: 'center',
                        marginTop: constants.vh(15)
                    }} />
                <Text style={styles.takeSelfie}>{'OR'}</Text>
                <CustomButton
                    onPress={() => { chooseGallary() }}
...
export default ProfileImageChooseScreen;